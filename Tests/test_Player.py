...
class TestPlayer(unittest.TestCase):
    ...
    def test_player_initialization(self):
        ...
        self.assertEqual(self.player.mode, 0)  # Verify player mode (irrelevant for humans)
    ...
    def test_valid_move(self, mock_input):
        ...
        self.assertEqual((row, col), (1, 1))  # Check if the move is correctly registered
    ...
    def test_invalid_move_out_of_bounds(self, mock_input):
        ...
        """
        row, col = self.player.make_move(self.player.number, self.board)
        self.assertEqual((row, col), (1, 1))  # Should retry and pick a valid move inside the board
